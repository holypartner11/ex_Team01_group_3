...
--- - --
## 销量前十书籍分析结论
![w:800](./output/Tsk1/python_books_top10_analysis.png)
...
![w:800](./output/Tsk3/出版社统计合并图表.png)
...
## 任务四：分析销量前 50 的 Python 类图书中，原价和折后价的分布，折扣率的分布特征

### 一、统计分析与可视化
![python_books_price_analysis_fixed](./output/Tsk4/python_books_price_analysis_fixed.png)
...
- #### 1. 原价分布分析
  ...
  - **折扣率**：峰值集中在 60%–80%（6–8 折），存在 3 本折扣率 > 100% 的溢价图书，可能为稀缺版本、新书溢价或其他。

## 原价和折后价的分布，折扣率的分布特征结论
...
![w:700](./output/Tsk5/Python图书书名词云.png)

--- - --

## 书名词频分析

![w:600](./output/Tsk5/Python图书词频综合分析.png)
...
这一结构特征揭示：当前Python畅销书的书名策略倾向于在单一主题上聚焦，跨领域综合类的书名表达相对稀少，出版方倾向于用精准的垂直标签锁定目标读者。
...
![w:800](./output/Tsk6/Tsk6_8类价格分析_4合1综合图.png)
...
- 可视化图表：1个（8类分类分布、价格对比、价格分布、折扣对比合并）
（需插入链接）
...
- 次选「数据分析与可视化」类：职场刚需，竞争相对较小；谨慎选择「量化交易/金融分析」类：样本量少，市场需求小众。
...
![w:800](./output/Tsk7/关键词分析整合图表.png)

--- - --

# 关键词与售价和销量关联分析结论与写书建议
